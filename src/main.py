...
def listen_chronit():
    ...
    if is_simulation_mode():
        ...
        print("   Esperando comandos de carrera (sin hardware)")
        ...
        while True:
            ...
            time.sleep(1)  # Revisar cada 1 segundo
        return  # Salir de la función (nunca llega, pero por claridad)
                        ...
                        try:
                            ...
                            for linea in lineas[:-1]:
                                ...
                                if not linea.startswith("#"):
                                    print(f"[SERIAL] Línea recibida: {repr(linea)}")
